...
class FieldBuilderClassTest {
  ...
  void randomString_when_twoInstancesCreated_then_notEqualsProp1() {
    final FieldBuilderClass fieldBuilder1 =
        FieldBuilderClassBuilder.create().randomString().prop2("asd").build();
    final FieldBuilderClass fieldBuilder2 =
        FieldBuilderClassBuilder.create().randomString().prop2("asd").build();
  ...
  void fromInt_when_usedInBuilder_then_prop1IsIntegerString() {
    final FieldBuilderClass fieldBuilder =
        FieldBuilderClassBuilder.create().fromInt(52).prop2("asd").build();
  ...
  void constant_when_usedInBuilder_then_prop3WithConstantValue() {
    final FieldBuilderClass fieldBuilder =
        FieldBuilderClassBuilder.create()
            .randomString()
            .prop2("asd")
            .andAllOptionals()
            .constant()
