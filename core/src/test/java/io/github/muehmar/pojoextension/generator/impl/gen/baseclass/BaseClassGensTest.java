  ...
  void baseClass_when_samplePojo_then_correctBaseClass() {
    ...
    assertEquals(
        "package io.github.muehmar;\n"
            + "\n"
            + "\n"
            + "public abstract class CustomerBase implements CustomerExtension {\n"
            + "  @Override\n"
  ...
  void baseClass_when_genericSamplePojo_then_correctBaseClass() {
    ...
    assertEquals(
        "package io.github.muehmar;\n"
            ...
            + "\n"
            + "public abstract class CustomerBase<T extends List<String>, S> implements CustomerExtension<T, S> {\n"
            + "  @Override\n"
            + "  public boolean equals(Object o) {\n"
            + "    return genEquals(o);\n"
            + "  }\n"
